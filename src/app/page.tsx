  ...
  return (
    <section className="grid md:grid-cols-12 gap-8 py-7 lg:py-14">
      <div className="md:col-span-7">
        <h1 className={`text-3xl md:text-5xl lg:pr-2 mb-3 ${styles.heading}`}>
          <span className={styles.underline}>Completing</span> the
          <br /> Interview Feedback Loop
        </h1>
        <p className={styles.headingSub}>
          Ghosted AI is your interview feedback assistant, we join your remote
          interviews, transcribe call audio, and then leverage the power of AI
          to provide you instant feedback on your interview performance.
        </p>
        <EmailSignup />
        <h2 className={`text-md mt-8 mb-6 ${styles.h3}`}>
...
function HowItWorksSection() {
  return (
    <section id="how-it-works" className="py-7 lg:py-14">
      <h2 className={`mb-8 text-xl md:text-4xl text-center ${styles.heading}`}>
        How it works
      </h2>
      <div className="grid md:grid-cols-3 gap-8">
        {how.map((h) => (
          <div
            key={h.title}
            className="text-center flex flex-col content-center items-center"
          >
            <div
            ...
            <p className={`mt-8 mb-4 md:text-xl ${styles.heading}`}>
              {h.title}
            </p>
            <p>{h.subtitle}</p>
          </div>
      ...
      <div className="text-center py-12">
        <a href="#join-waitlist" className="primary-button">
          Join Waitlist!
        </a>
      </div>
    </section>
    ...
    <section id="join-waitlist" className="py-7 lg:py-14">
      <div className="grid md:grid-cols-2">
        ...
        <div className="flex flex-col h-full justify-center">
          <h2 className={`text-lg md:text-2xl mb-8 ${styles.accessTitle}`}>
            Provide your details for early access to our private beta!
          </h2>
          <EmailSignup />
        </div>
      </div>
